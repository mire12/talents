...
public class TalentsApp {

    private static final Logger log = LoggerFactory.getLogger(TalentsApp.class);

    private final Environment env;

    public TalentsApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TalentsApp.class);
